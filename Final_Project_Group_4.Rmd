...
cbinded %>%
  kbl(caption = "<b>Table 8:</b> Binary Logistic Regression Analysis with 95% CI") %>%
...
Given barcharts from table 2 and 5, the trend of **MISPHLPF** and **X_BMI5CAT** are not monotonic. Therefore, quadratic terms were introduced in the binary logistic regression model.
