...
write.csv(brfss_sleep_mental,"/Users/hehehe/Desktop/brfss_sleep_mental.csv")
```

```{r}
read.csv("/Users/hehehe/Desktop/brfss_sleep_mental.csv")
```
...
expected_sex <- chisq.test(data.mat)$expected
expected_sex
```
