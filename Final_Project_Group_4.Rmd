...
From barcharts from table 2 and 5, the trend of **MISPHLPF** and **X_BMI5CAT** are not monotonic. Therefore, quadratic terms were introduced in the binary logistic regression model.
```{r message=FALSE, warning=FALSE, echo=FALSE, include = FALSE}
adjusted <- step(model, direction = "backward")
summary(adjusted)
```
